...
public class ViewModelBase : ObservableObject
{
    public Dictionary<string, string> ErrorMessages = new()
    {
        ...
        ["ModelRefresh_ShortMessage_ServiceError"] = "The dataset refresh failed due to a temporary Power BI service issue. Please try refreshing again later. If the problem continues, contact Power BI support for assistance."
    };
}